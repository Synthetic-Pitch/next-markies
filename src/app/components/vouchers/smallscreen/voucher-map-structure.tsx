    ...
    return (
        <main className='w-[90%] sxs:h-[120px] bg-[#cecece]'>
            <section className='flex flex-col sxs:flex-row items-center h-full w-full'>
                {
                    <div className='w-[50%] h-[100px] sxs:full relative flex justify-center items-center'>
                        <Image src={url} alt='' height={50} width={120} className='max-h-[98%]'/>
                    </div>
                }
                <div className='flex flex-col py-2 pl-2 font-poppins text-[14px] text-[#494949]'>
                    ...
                    <div className='text-inherit'>{'stocks: '+ stocks}</div>
